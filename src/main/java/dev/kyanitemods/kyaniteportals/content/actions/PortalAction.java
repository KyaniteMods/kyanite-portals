...
public abstract class PortalAction<T extends PortalAction<T>> {
    ...
    public record Settings(Optional<ContextAwarePredicate> predicate, float probability, @NotNull List<PortalAction<?>> onSuccess, @NotNull List<PortalAction<?>> onFailure, Optional<Set<FailureReason>> failureReasons, PortalActionEnvironment environment, ActionLocationOptions locationOptions) {
        ...
        public static final Codec<Settings> REQUIRED_LOCATION_CODEC = RecordCodecBuilder.create(instance -> instance.group(
                CodecHelper.ENTITY_PREDICATE_ADVANCEMENT_CODEC.optionalFieldOf("predicate").forGetter(Settings::predicate),
        ...
        public static final class Builder {
            ...
            private Optional<ContextAwarePredicate> predicate = DEFAULT.predicate();
            ...
            public Builder predicate(ContextAwarePredicate predicate) {
                this.predicate = Optional.ofNullable(predicate);
                return this;
            }

            public Builder predicate(EntityPredicate predicate) {
                this.predicate = Optional.ofNullable(predicate).map(EntityPredicate::wrap);
                return this;
            }
